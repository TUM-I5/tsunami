...
echo "**** Runing swe_workshop script ****"
echo "PWD=$PWD"
...
#user variables
  ...
  DISPLSCRIPT=scripts/CalculateSeafloorDisplacement.py
  ...
  DISPLCONFIG=data/subfaults/2010_02_27_chile_30sec.cfg  
  ...
  DISPLREFORMATSCRIPT=scripts/reformat.r
